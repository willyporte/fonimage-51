...
return [
    ...
    */
    ...
    'custom'               => [
        'image_file' => [
            'required' => 'Per forza devi caricare una immagine!',
            'mimes' => 'Il tipo dell\'imaggine dev\'essere: .jpg, .jpeg, .bmp o png.',
        ],
        'description' => [
            'required' => 'Obbligatorio inserire una descrizione',
            'min' => 'La descrizione dell\'immagine dev\'essere di almeno 3 caratteri',
        ],
    ],
